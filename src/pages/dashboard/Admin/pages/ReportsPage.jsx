...
export default function ReportsPage() {
  ...
  const reportsData = {
    all: [
      { id: 1, name: "تحسين خدمات المرافق", role: "مدير نظام", date: "July 1, 2024", status: "Done", actions: "تم الاستلام" },
      ...
      { id: 5, name: "تبديل مواعيد الحصص", role: "مدير نظام", date: "July 28, 2024", status: "Progress", actions: "لم يتم الإرسال" },
      { id: 6, name: "تعديل على الأنشطة", role: "مدير مدرسة", date: "July 29, 2024", status: "Pending", actions: "-" },
      ],
    admins: [
      { id: 1, name: "إضافة ميزة للمنصَّة", role: " مدير نظام", date: "July 5, 2024", status: "Done", actions: "تم الاستلام" },
          { id: 2, name: "تعديل على واجهة تسجيل الدخول", role: " مدير نظام", date: "July 8, 2024", status: "Pending", actions: "-" },
      { id: 3, name: " إضافة مدارس جديدة", role: " مدير نظام", date: "July 9, 2024", status: "Progress", actions: "لم يتم الإرسال"},
