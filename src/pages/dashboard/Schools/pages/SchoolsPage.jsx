// =============================================================================
// Enhanced Schools Management Page for Schools
// صفحة إدارة المدارس المتطورة  Schools
// =============================================================================
...
const SchoolsPage = () => {
  ...
  const handleViewDetails = (school) => {
    navigate(`/dashboard/Schools/schools/${school.id}`);
  };

  const handleEvaluateSchool = (school) => {
    navigate(`/dashboard/Schools/evaluations?schoolId=${school.id}`);
  };

  const handleCompare = (school) => {
    navigate('/dashboard/Schools/schools/comparison', { state: { school } });
  };
