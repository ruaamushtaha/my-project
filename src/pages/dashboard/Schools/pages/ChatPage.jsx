...
const ChatPage = () => {
  ...
  return (
    <motion.div 
      className="container mx-auto p-4 flex flex-col h-[calc(100vh-120px)]"
      dir="rtl"
      ...
      >
        <div className="flex flex-1 overflow-hidden">
          ...
          <motion.aside
            ...
            className="border-l border-gray-200 dark:border-gray-700 flex flex-col w-full md:w-1/3"
          >
                  ...
                  {conversations.map((conversation) => {
                    ...
                    return (
                      <motion.div
                        ...
                        whileHover={{ scale: 1.03, boxShadow: "0 2px 12px rgba(0,0,0,0.15)" }}
                        whileTap={{ scale: 0.98 }}
                      ...
                      >
                        <div className="flex items-start justify-between">
                          {/* Avatar and text content - reversed order */}
              ...
              >
                ...
                >
                  <div className="flex items-center">
                    ...
                    />
                    {/* Name and info on the right of avatar */}
