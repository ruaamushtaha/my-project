// =============================================================================
// Enhanced Header Component for school  Dashboard
 ...
 */
const SchoolsHeader = ({ title, subtitle, breadcrumbs = [], onMenuClick }) => {
...
>
  <div className="w-full px-4 lg:px-6">
    <div className="flex items-center justify-between h-16 lg:h-20" dir="rtl">
        ...
        <div className="relative">
          ...
          >
            ...
            <div className="flex flex-col items-start text-left">
              ...
              <span className="text-sm text-gray-400 dark:text-gray-500">مدير مدرسة</span>
            </div>
          </Button>
              ...
              >
                ...
                <div className="py-2">
                  <button
                    ...
                    onClick={() => {
                      setProfileMenuOpen(false);
                      navigate('/dashboard/Schools/profile');
                    }}
                  >
                  ...
                  <button
                    ...
                    onClick={() => {
                      setProfileMenuOpen(false);
                      navigate('/dashboard/Schools/settings');
                    }}
                  >
