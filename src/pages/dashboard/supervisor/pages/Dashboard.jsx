...
const Dashboard = () => {
  ...
  const statsData = [
    { title: 'المدارس المُشرف عليها', value: '12', trend: '+2%', icon: School, color: 'primary' },
    { title: 'الشكاوى المعلقة', value: '8', trend: '+15%', icon: AlertTriangle, color: 'danger' },
    { title: 'التقييمات المكتملة', value: '45', trend: '+8%', icon: ClipboardCheck, color: 'success' },
    { title: 'التقارير الميدانية', value: '23', trend: '+12%', icon: FileText, color: 'warning' },
  ];
  ...
  const quickActions = [
    { 
      ...
      action: () => navigate('/dashboard/supervisor/schools')
    },
    { 
      label: 'الشكاوى', 
      icon: AlertTriangle, 
      color: 'from-rose-500 via-red-600 to-pink-600',
      action: () => navigate('/dashboard/supervisor/complaints')
    },
    { 
      label: 'التقييمات', 
      icon: ClipboardCheck, 
      color: 'from-emerald-500 via-green-600 to-teal-600',
      action: () => navigate('/dashboard/supervisor/evaluations')
    },
    { 
      label: 'التقارير', 
      icon: FileText, 
      color: 'from-purple-500 via-violet-600 to-fuchsia-600',
      action: () => navigate('/dashboard/supervisor/reports')
    }
  ];
    ...
    <div className="container mx-auto" dir="rtl">
      ...
      >
        ...
        <p className="text-gray-600 dark:text-gray-400 mt-2">
          نظرة عامة على نشاطات الإشراف والمدارس
        </p>
      </motion.div>
            ...
            <div className="h-80">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={activityData}>
                  ...
                  <Bar dataKey="visits" fill="url(#visitsGradient)" name="الزيارات الميدانية" radius={[8, 8, 0, 0]} />
                  <Bar dataKey="reports" fill="url(#reportsGradient)" name="التقارير" radius={[8, 8, 0, 0]} />
                  <Bar dataKey="evaluations" fill="url(#evaluationsGradient)" name="التقييمات" radius={[8, 8, 0, 0]} />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </div>
