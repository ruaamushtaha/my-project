...
const navigationItems = [
  ...
  },
  {
    ...
    label: 'المدارس',
    icon: School,
    path: '/dashboard/supervisor/schools',
  },
  {
    id: 'complaints',
    label: 'الشكاوى',
    icon: AlertTriangle,
    path: '/dashboard/supervisor/complaints',
  },
  {
    id: 'evaluations',
    label: 'التقييمات',
    icon: ClipboardCheck,
    path: '/dashboard/supervisor/evaluations',
  },
  {
    id: 'reports',
    label: 'التقارير',
...
const bottomItems = [
  {
    ...
    label: 'الملف الشخصي',
    icon: User,
    path: '/dashboard/supervisor/profile',
  },
  {
    id: 'settings',
    label: 'الإعدادات',
          ...
          <div className="flex items-center justify-between">
            <div className={`flex items-center gap-3 ${isCollapsed ? 'justify-center' : ''}`}>
              ...
              {!isCollapsed && (
                ...
                >
                  <h1 className="font-bold text-gray-900 dark:text-white">نظام الإشراف التربوي</h1>
                  <p className="text-xs text-gray-500 dark:text-gray-400">لوحة المشرف</p>
                </motion.div>
              )}
            </div>
            {!isCollapsed && (
