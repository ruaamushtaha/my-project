...
const EvaluationCriteriaChart = () => {
  ...
  const data = {
    labels: chartsData.evaluationCriteria?.criteria || [
      'أخرى', 'الخدمات', 'الأنشطة التفاعلية', 'الإدارة',
      'الأنشطة التفاعلية', 'جودة التعليم'
    ],
    datasets: [
      {
        label: 'نسبة التقييم',
        data: chartsData.evaluationCriteria?.ratings || [0, 0, 0, 0, 0, 0],
        backgroundColor: [
          '#A0BCE8', '#62C8CC', '#000000', '#2DA1DE',
          '#FFA726', '#71DD8C'
        ],
        borderRadius: {
          topLeft: 6,
