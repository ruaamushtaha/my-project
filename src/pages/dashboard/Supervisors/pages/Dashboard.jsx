            ...
            <Card className="h-full flex flex-col">
              <div className="flex items-center justify-between mb-6">
                ...
                <Button 
                  variant="outline" 
                  size="sm"
                  onClick={() => navigate('/dashboard/Supervisors/schools')}
                >
                  <FaEye className="ml-2" />
                  عرض الكل
                </Button>
            ...
            <Card className="h-full flex flex-col">
              ...
              <div className="mt-6 pt-4 border-t border-gray-200 dark:border-gray-600">
                <Button 
                  variant="ghost" 
                  className="w-full"
                  onClick={() => navigate('/dashboard/Supervisors/notifications')}
                >
                  <FaEye className="ml-2" />
                  عرض جميع الأنشطة
                </Button>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              { 
                ...
                action: () => navigate('/dashboard/Supervisors/evaluations')
              },
              { 
                label: 'إرسال رسالة', 
                icon: FaComments, 
              ...
              { 
                ...
                action: () => navigate('/dashboard/Supervisors/reports')
              },
              { 
                label: 'التقويم', 
                icon: FaCalendarAlt, 
                color: 'from-purple-500 to-purple-600',
                action: () => navigate('/dashboard/Supervisors/calendar')
              }
            ].map((action, index) => (
              <motion.button
                key={action.label}
