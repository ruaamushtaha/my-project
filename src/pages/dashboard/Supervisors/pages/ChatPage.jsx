...
import { FaPaperPlane, FaComments, FaUser, FaSchool, FaSearch,FaSmile, FaPaperclip, FaExclamationTriangle } from 'react-icons/fa';
...
const ChatPage = () => {
  ...
  const validateMessage = (message) => {
    ...
    if (trimmedMessage.length > 1000) {
      return 'الرسالة يجب ألا تتجاوز 1000 حرف';
    }
  ...
  const handleSendMessage = async () => {
    ...
    if (!activeConversation) {
      setMessageError('الرجاء اختيار محادثة');
      return;
    }
    ...
    try {
      ...
      setMessageError('حدث خطأ أثناء إرسال الرسالة. الرجاء المحاولة مرة أخرى.');
    }
  };
