...
const navigationItems = [
  ...
  { id: 'evaluations', label: 'التقييمات', icon: FaStar, path: '/dashboard/Supervisors/evaluations' },
  ...
  { id: 'complaints', label: 'الشكاوى', icon: FaExclamationTriangle, path: '/dashboard/Supervisors/complaints' },
