...
const navigationItems = [
  ...
  { id: 'schools', label: 'المدارس', icon: FaSchool, path: '/dashboard/parents/schools' },
  { id: 'reports', label: 'التقارير', icon: FaFileAlt, path: '/dashboard/parents/reports' },
  { id: 'calendar', label: 'التقويم', icon: FaCalendarAlt, path: '/dashboard/parents/calendar' },
  { id: 'complaints', label: 'رفع شكاوي', icon: FaExclamationTriangle, path: '/dashboard/parents/complaints' },
  { id: 'chat', label: 'المحادثة', icon: FaComments, path: '/dashboard/parents/chat' },
  { id: 'notifications', label: 'الإشعارات', icon: FaBell, path: '/dashboard/parents/notifications' },
];

const bottomItems = [
  { id: 'profile', label: 'الملف الشخصي', icon: FaUser, path: '/dashboard/parents/profile' },
  { id: 'settings', label: 'الإعدادات', icon: FaCog, path: '/dashboard/parents/settings' },
];
