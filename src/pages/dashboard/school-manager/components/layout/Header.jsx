                  ...
                  >
                    <div className="p-4 border-b border-gray-200 dark:border-gray-600">
                      <div className="flex items-center space-x-3 space-x-reverse">
                        ...
                        <div>
                          <p className="font-medium text-gray-900 dark:text-white">مدير المدرسة</p>
                          <p className="text-sm text-gray-500 dark:text-gray-400">manager@school.com</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="py-2">
                      <button 
                        ...
                        onClick={() => navigate('/dashboard/school-manager/profile')}
                      >
                      ...
                      <button 
                        className="w-full flex items-center space-x-3 space-x-reverse px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors text-right"
                        onClick={() => navigate('/dashboard/school-manager/settings')}
                      >
