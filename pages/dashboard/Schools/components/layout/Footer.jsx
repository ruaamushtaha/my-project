...
/**
 * school Dashboard Footer Component
 * مكون تذييل الصفحة لداشبورد  school
 */
const Footer = () => {
...
>
  ...
  >
    {/* border  */}
    <div className="absolute top-3 left-6 right-6 border-t border-[#E3E8E9]" />

    {/* Right side - Copyright */}
    <div
      className="text-sm text-white font-light ml-5"
    ...
    {/* Left side - Links */}
    <div className="flex items-center gap-x-6 mr-8 my-2">
