...
export default function ReportsPage() {
  ...
  const reports = [
    { id: 1, name: "تحسين خدمات المرافق", school: "الأمل", date: "July 1, 2024", status: "Done", actions: "تم التسليم" },
    { id: 2, name: "تعديل على الأنشطة", school: "المتميِّزون", date: "July 25, 2024", status: "Progress", actions: "يتم التحميل " },
    { id: 3, name: "تحسين خدمات المرافق", school: "الأمل", date: "August 1, 2024", status: "Progress", actions: "يتم التحميل" },
    { id: 4, name: "تحسين خدمات المرافق", school: "الأمل", date: "August 22, 2024", status: "Pending", actions: "-" },
    { id: 5, name: "تحسين خدمات المرافق", school: "الأمل", date: "August 29, 2024", status: "Pending", actions: "-" },
    { id: 6, name: "تحسين خدمات المرافق", school: "الأمل", date: "September 5, 2024", status: "Pending", actions: "-" },
  ];
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 p-8" dir="rtl">
      ...
      {/* Table */}
      <div>
        <div className="grid grid-cols-5 bg-gray-100 dark:bg-gray-800 p-2 text-right font-semibold text-gray-500 dark:text-gray-200 rounded-t-lg">
          <div>اسم التقرير</div>
          <div>المدرسة</div>
          <div>التاريخ</div>
        ...
        <div className="space-y-2 p-2">
          {reports
            ...
            .map((report) => (
              ...
              >
                <div className="text-slate-950 dark:text-gray-200">{report.name}</div>
                <div className="text-gray-500 dark:text-gray-300">{report.school}</div>
                <div className="text-gray-500 dark:text-gray-300">{report.date}</div>
                <div>
                ...
                <div className="text-gray-500 dark:text-gray-300">{report.actions}</div>
              </div>
            ))}
        </div>
      </div>
      ...
      {/* Stats Cards */}
      <div className="flex gap-6 mb-8 m-5">
        {/* Card 1 */}
